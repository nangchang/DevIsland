...
final class PluginEventFactoryTests: XCTestCase {
    ...
    private func makeHook(
        ...
        ParsedHookEvent(
            ...
            terminal: TerminalContext(app: terminalApp),
    ...
    private func makeSession(
        ...
        ActiveSession(
            ...
            terminalTitle: "Terminal",
            agentKind: agentKind,
            terminal: TerminalContext(app: "iTerm", tty: terminalTTY, windowId: "1", tabIndex: "2", tmuxPane: "%1", tmuxSocket: "/tmp/tmux.sock", tmuxClient: "client"),
